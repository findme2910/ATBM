...
public class RSADSModel {
 ...
 // Constructor với thuật toán RSA cố định để thực hiện chữ kí điện tử
    public RSADSModel() throws NoSuchAlgorithmException {
    ...
    public boolean verifyText(String text, String signedData) throws InvalidKeyException, SignatureException {
        byte[] hashedData = messageDigest.digest(text.getBytes());
